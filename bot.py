# bot.py - COMPLETE WITH QR, PLANS, AUTO APPROVE
import os
import sys
import json
import sqlite3
...
'''
    ...
    def setup_handlers(self):
        ...
        def deploy_bot(message):
            ...
            credits = self.db.get_available_credits(user_id)
            if credits <= 0:
                self.bot.send_message(message.chat.id, f"❌ No credits.\nBuy credits first.", parse_mode='Markdown')
                return
        ...
        def process_bot_token(message):
            ...
            msg = self.bot.send_message(message.chat.id, "⏳ Validating...", parse_mode='Markdown')
        ...
        def process_add_credits_amount(message, user_id):
            ...
            try:
                ...
                if count <= 0:
                    ...
                    return
                # Use default plan price 99, validity 15
