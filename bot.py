...
# ==================== CONFIG ====================
BOT_TOKEN = "8202779834:AAHOuH3Qr5t8eyw-adUoAlpqvlptQAXokek"
ADMIN_IDS = []
...
# Plans keyboard - 1 plan per line
def plans_keyboard():
...
def start_cmd(msg):
    ...
    # Change kiya: "👇 Choose a plan below 💎"
    ...
    try:
        ...
        # ========== VIEW PLAN ==========
            ...
            if plan:
                ...
                # Videos ek sath (Telegram doesn't support video albums)
                if videos:
                    for video in videos:
